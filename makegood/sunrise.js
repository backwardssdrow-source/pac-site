'use strict';
const pageTitle='MakeGood Co. | Services and Founding Pricing';
...
function closeService(){serviceModal.close();if(location.hash.startsWith('#service-'))history.replaceState(null,'',location.href.split('#')[0]+'#services');document.title=pageTitle;if(lastTrigger&&document.contains(lastTrigger))lastTrigger.focus({preventScroll:true});}
